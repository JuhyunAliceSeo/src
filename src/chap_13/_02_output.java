...
public class _02_output {
    public static void main(String[] args) {
        ...
        System.out.printf("%6d%n", 1234); // __1234 (6만큼의 공간을 만들고 1234를 출력)
        System.out.printf("%06d%n", 1234); //001234 (6만큼의 공간을 만들고 1234를 출력하는데 빈 공간은 0으로 채움)
        ...
        System.out.printf("%-6d%n", 1234); //1234__(6자리의 공간을 확보하고 나서 왼쪽 정렬 1234를 출력)
        ...
        System.out.printf("%6.2s%n", "Java"); //____Ja(6자리 공간 확보후 앞에 우측 정렬해서 2글자만 출력)
        System.out.printf("%-6.2s%n", "Java"); //Ja____(6자리 공간 확보후 앞에 좌측 정렬해서 2글자만 출력)
